...
const CandlestickChart3D = dynamic(
  () => import("@/components/three/CandlestickChart3D"),
  { ssr: false },
);
    ...
    >
      ...
      <GlassCard className="p-4">
        ...
        <p className="text-xs mb-3" style={{ color: "var(--text-secondary)" }}>
          Scroll to zoom · Green = up day, Red = down day
        </p>
        <CandlestickChart3D />
      </GlassCard>
