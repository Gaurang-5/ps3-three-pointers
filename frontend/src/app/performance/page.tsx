...
export default function PerformancePage() {
  ...
  const metricCards = [
    {
      label: "Sharpe Ratio",
      value: (m["Sharpe Ratio"] ?? 0).toFixed(2),
      sublabel: "Annualized",
      deltaType: getDeltaType(m["Sharpe Ratio"] ?? 0, 1),
    },
    {
      label: "Alpha",
      value: formatPercent(m["Alpha"] ?? 0),
      sublabel: "vs benchmark",
      deltaType: getDeltaType(m["Alpha"] ?? 0),
    },
    {
      label: "Beta",
      value: (m["Beta"] ?? 0).toFixed(3),
      sublabel: "Market correlation",
      deltaType: "neutral" as const,
    },
    {
      label: "Ann. Return",
      value: formatPercent(m["Total Return"] ?? 0),
      sublabel: "Cumulative",
      deltaType: getDeltaType(m["Total Return"] ?? 0),
    },
    {
    ...
    {
      label: "Max Drawdown",
      value: formatPercent(m["Max Drawdown"] ?? 0),
